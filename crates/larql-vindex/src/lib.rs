...
pub use extract::{
    ...
    build_vindex_streaming, build_vindex_streaming_gguf,
...
pub use format::weights::{write_model_weights, load_model_weights, load_model_weights_selective, WeightSource, StreamingWeights};
